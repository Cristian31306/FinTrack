...
class AiAssistantService
{
    ...
    private function getToolsDefinition(): array
    {
        return [
            ...
            ['type' => 'function', 'function' => ['name' => 'prepare_category', 'description' => 'Prepara categoría.', 'parameters' => ['type' => 'object', 'properties' => ['name' => ['type' => 'string'], 'icon' => ['type' => 'string'], 'color' => ['type' => 'string']], 'required' => ['name']]]],
