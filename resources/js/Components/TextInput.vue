...
<template>
    <div v-if="isPassword" class="relative w-full" :class="$attrs.class">
        <input
        ...
        <button
            type="button"
            class="absolute inset-y-0 right-0 flex items-center justify-center w-12 text-slate-400 hover:text-brand-500 transition-colors"
