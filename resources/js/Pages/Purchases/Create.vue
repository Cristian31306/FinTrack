...
const hasCards = computed(() => props.creditCards && props.creditCards.length > 0);
    ...
    <AuthenticatedLayout>
        ...
        <div class="py-8">
            <div class="mx-auto max-w-2xl px-4 sm:px-6 lg:px-8">
                ...
                <div v-if="!hasCards" class="rounded-[2.5rem] bg-white p-10 shadow-premium text-center">
                    <div class="mx-auto mb-6 flex h-20 w-20 items-center justify-center rounded-2xl bg-[#C8B07D]/10">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 text-[#C8B07D]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z" />
                        </svg>
                    </div>
                    <h3 class="text-xl font-black uppercase tracking-tight text-[#111111]">Sin tarjetas registradas</h3>
                    <p class="mt-2 text-sm text-gray-500 leading-relaxed">
                        Para registrar una compra primero debes agregar al menos una tarjeta de crédito a tu cuenta.
                    </p>
                    <Link
                        :href="route('credit-cards.create')"
                        class="mt-6 inline-flex items-center gap-2 rounded-xl bg-[#C8B07D] px-6 py-3 text-sm font-black uppercase tracking-widest text-white shadow-lg shadow-[#C8B07D]/25 transition-all hover:bg-[#A68F5B] hover:scale-105"
                    >
