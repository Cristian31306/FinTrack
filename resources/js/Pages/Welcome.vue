...
<template>
    ...
    <div class="relative min-h-screen overflow-hidden bg-slate-950 text-slate-100 antialiased">
        <!-- Fondo Minimalista -->
        ...
        <!-- Nav -->
        <header class="relative z-10 border-b border-white/5 bg-slate-950/70 backdrop-blur-xl">
            <div class="mx-auto flex h-16 max-w-6xl items-center justify-between px-4 sm:px-6 lg:px-8">
                <Link href="/" class="flex items-center gap-2.5">
                    <span
                        class="flex h-10 w-10 items-center justify-center rounded-xl bg-white text-black text-xl font-black shadow-lg">F</span>
                    <span class="text-xl font-black tracking-tighter text-white uppercase">FinTrack</span>
                </Link>
        ...
        <main>
            <!-- Hero -->
            <section class="relative mx-auto max-w-6xl px-4 pb-20 pt-16 sm:px-6 sm:pb-28 sm:pt-24 lg:px-8 lg:pt-28">
                <div class="mx-auto max-w-3xl text-center">
                    ...
                    <h1 class="text-4xl font-extrabold tracking-tight text-white sm:text-5xl lg:text-6xl">
                        ...
                        <span
                            class="bg-gradient-to-r from-emerald-300 via-teal-200 to-cyan-300 bg-clip-text text-transparent">claro
                            y bajo control</span>
                    </h1>
                    <p class="mx-auto mt-6 max-w-2xl text-lg leading-relaxed text-slate-400 sm:text-xl">
                ...
                <div class="relative mx-auto mt-24 max-w-xl group">
                    ...
                    <div ref="targetCard" :style="{ transform: cardTransform }"
                        ...
                        <div class="flex justify-between items-start">
                            <div class="space-y-1">
                                <h2 class="text-2xl font-black text-white tracking-tighter uppercase italic">Capital
                                    Insight
                                </h2>
                                <p class="text-[10px] font-bold text-slate-500 uppercase tracking-widest">Global Credit
                                    Simulation · EA {{ interestRateEA }}%</p>
                            </div>
                            <div class="bg-white/5 rounded-full px-4 py-1 border border-white/5">
                                <span class="text-[10px] font-black text-[#C8B07D] uppercase tracking-widest">Live
                                    Status</span>
                            </div>
                        </div>
                        ...
                        <div class="space-y-8">
                            <div class="space-y-3">
                                <div class="flex justify-between items-end px-1">
                                    <label class="text-[10px] font-black text-slate-500 uppercase tracking-widest">Monto
                                        de
                                        Operación</label>
                                    <span class="text-xl font-bold text-white tracking-tight">${{ (amount ||
                                        0).toLocaleString()
                                        }}</span>
                                </div>
                                <div class="relative group/input">
                                    <input v-model="amount" type="number" placeholder="Ingrese monto"
                            ...
                            <div class="space-y-4">
                                <div class="flex justify-between items-end px-1">
                                    <label class="text-[10px] font-black text-slate-500 uppercase tracking-widest">Plazo
                                        (Meses)</label>
                                    <span class="text-xl font-bold text-[#C8B07D] tracking-tight">{{ installments
                                        }}</span>
                                </div>
                                <input type="range" min="1" max="36" v-model="installments"
                        ...
                        <div class="pt-10 border-t border-white/5 grid gap-8">
                            <div class="grid grid-cols-2 gap-8 text-center sm:text-left">
                                <div class="space-y-1">
                                    <p class="text-[10px] font-black text-slate-500 uppercase tracking-widest">Cuota
                                        Estimada
                                    </p>
                                ...
                                <div class="space-y-1">
                                    <p class="text-[10px] font-black text-slate-500 uppercase tracking-widest">Costo
                                        Financiero
                                    </p>
                            ...
                            <!-- AI INSIGHT STATUS -->
                            <div class="rounded-[1.5rem] p-6 border transition-all duration-700"
                                    ...
                                    <div class="flex items-center gap-3">
                                        <div class="relative flex h-2 w-2">
                                            <span
                                                ...
                                                :class="feedback.ping"></span>
                                            <span class="relative inline-flex rounded-full h-2 w-2"
                                                :class="feedback.dot"></span>
                                        </div>
                                        <span class="text-[10px] font-black tracking-[0.2em]" :class="feedback.color">{{
                                            feedback.text }}</span>
                                    </div>
                                    <span
                                        class="text-[10px] font-black text-white opacity-40 uppercase tracking-widest">Index
            ...
            <!-- Features -->
            <section class="border-t border-white/5 bg-slate-900/40 py-20 backdrop-blur-sm">
                <div class="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
                    ...
                    <ul class="mt-14 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
                        <li v-for="f in features" :key="f.title" class="group rounded-2xl border border-white/10 bg-slate-900/60 p-6 
                            ...
                            <div
                                ...
                                <svg v-if="f.icon === 'card'" class="h-5 w-5" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z" />
                                </svg>
                                <svg v-else-if="f.icon === 'installment'" class="h-5 w-5" fill="none"
                                    stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 14h.01M12 14h.01M15 11h.01M12 11h.01M9 11h.01M7 21h10a2 2 0 002-2V5a2 2 0 00-2-2H7a2 2 0 00-2 2v14a2 2 0 002 2z" />
                                </svg>
                                <svg v-else-if="f.icon === 'split'" class="h-5 w-5" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <h3 class="text-lg font-semibold text-white group-hover:text-emerald-200">
                                {{ f.title }}
                            </h3>
            ...
            <section class="py-20">
                <div class="mx-auto max-w-3xl px-4 text-center sm:px-6 lg:px-8">
                    ...
                    <div v-if="canLogin && canRegister && !$page.props.auth?.user" class="mt-8">
