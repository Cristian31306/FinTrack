...
const form = useForm({
    ...
    statement_day: String(props.creditCard.statement_day),
    payment_day: String(props.creditCard.payment_day),
            ...
            <div class="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
                <div class="grid grid-cols-1 gap-12 lg:grid-cols-2">
                    ...
                    >
                        ...
                        <!-- Tip: visible solo en móvil, dentro del form -->
                        <div class="lg:hidden rounded-2xl bg-[#C8B07D]/5 p-4 border border-[#C8B07D]/20">
                            <div class="flex gap-3 items-start">
                                ...
                                <div>
                                    <h4 class="text-xs font-black uppercase tracking-tight text-[#111111]">Información</h4>
                                    <p class="mt-1 text-xs font-medium text-gray-500 leading-relaxed">
                                        Los cambios se reflejarán inmediatamente en tus reportes y cálculos de deudas.
                                    </p>
                                </div>
                            </div>
                        </div>
